...
function endBattle() {
    ...
    } else if (game.target.hp <= 0 && !game.tutorialDone) { // Win condition and tutorial not done
        game.tutorialDone = true; // Set to true after first win
        queueOutput("Train and learn 10 Jutsu to prepare for your Genin promotion!");
        showStyleSelect(); // Force style select after win
    }
        }
