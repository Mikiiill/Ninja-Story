...
class BattleScene {
    ...
    selectStyle(style) {
        if (isInputLocked) {
            console.log(`Style ${style} blocked: input locked`);
            return;
        }
    ...
    selectSkill(skillName) {
        if (isInputLocked) {
            console.log(`Skill ${skillName} blocked: input locked`);
            return;
        }
        let skill = this.skills.findSkill(skillName);
        if (!skill) {
    ...
    selectSkillCard(skillName) {
        if (isInputLocked) {
            console.log(`Skill card ${skillName} blocked: input locked`);
            return;
        }
        let skill = this.skills.findSkill(skillName);
        if (!skill) {
            console.log(`Skill card ${skillName} not found`);
            return;
        }
